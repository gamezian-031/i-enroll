        ...
        <div class="content">
            <div class="h-100 d-flex flex-row">
                ...
                <div class="d-flex flex-column justify-content-between
                    ...
                    <div class="w-100 d-flex flex-row justify-content-between align-items-center pb-0 border-bottom border-3 border-dark">
                        <h2 class="fs-3 text-dark d-flex"> Students List (Regular / New)</h2>
                        <input class="py-1 px-2 ms-auto" id="studSearch" type="text" placeholder="Search..">
                    </div>
                    <?php
                        include('functions/php/config.php');
                        
                        $query = "SELECT * FROM `user-student` WHERE `status` = 'R' OR `status` = 'N'";
