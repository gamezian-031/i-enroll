<?php
    ...
    while($row = $query -> fetch_assoc()) { 
        ?>
        <form 
            action="functions/php/editFaculty.php" 
            method="post">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-floating">
                            ...
                            placeholder="idFaculty" value="<?php echo $row['idFaculty']?>"  />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-floating">
                            ...
                            placeholder="password" value="<?php echo dataDecrypt($row['idFaculty'], $row['password'])?>"  />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-floating">
                            ...
                            placeholder="email" value="<?php echo dataDecrypt($row['idFaculty'], $row['email'])?>"  />
